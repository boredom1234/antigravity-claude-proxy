...
const tests = [
  ...
  {
    name: "Multi-turn Tools (Non-Streaming)",
    file: "test-multiturn-thinking-tools.cjs",
  },
  {
    name: "Multi-turn Tools (Streaming)",
    file: "test-multiturn-thinking-tools-streaming.cjs",
  },
...
async function main() {
  ...
  console.log("");
  console.log(
    "Make sure the server is running on port 8672 before running tests."
  );
  console.log("");
