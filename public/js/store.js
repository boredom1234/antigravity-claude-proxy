  ...
  Alpine.store("global", {
    ...
    translations: {
      en: {
        ...
        tier: "Tier",
        quota: "Quota",
        forceRefreshTokens: "Force Refresh Tokens",
        forceRefreshDesc: "Clear in-memory token/project caches and force a fresh token fetch.",
        tokenCacheCleared: "Token cache cleared and refreshed",
      ...
      zh: {
        ...
        tier: "层级",
        quota: "配额",
        forceRefreshTokens: "强制刷新令牌",
        forceRefreshDesc: "清除内存中的令牌/项目缓存并强制重新获取。",
        tokenCacheCleared: "令牌缓存已清除并刷新",
        enabledStatus: "已启用",
        disabledStatus: "已禁用",
        logLevelInfo: "信息",
        logLevelSuccess: "成功",
